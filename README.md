...
Export yuque repository to markdown files. Although I found it mighbe not be useful to host it as a web service (due to the rate limit of yuque and it might be slow if you have a lot of docs), it could be an example of how to interact with yuque api.
